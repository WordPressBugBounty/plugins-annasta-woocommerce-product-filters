<?php if ( ! defined( 'ABSPATH' ) ) { exit; } ?>
              <tr>
                <td>
                  <label for="<?php echo esc_attr( $filter->prefix ); ?>show_active"><?php esc_html_e( 'Show active filter badges', 'annasta-filters' ); ?></label>
                ...
                <div class="awf-fo-flex1">
                  <input type="checkbox" name="<?php echo esc_attr( $filter->prefix ); ?>show_active" id="<?php echo esc_attr( $filter->prefix ); ?>show_active" value="yes"<?php if( ! empty( $value ) ) { echo ' checked="checked"'; } ?>>
<?php if( isset( $filter->settings['active_prefix'] ) ) : ?>
                  <div class="awf-fo-flex1-child">
                    ...
                    <input name="<?php echo esc_attr( $filter->prefix ); ?>active_prefix" id="<?php echo esc_attr( $filter->prefix ); ?>active_prefix" type="text" value="<?php echo esc_attr( $filter->settings['active_prefix'] ); ?>">
                  </div>
<?php endif; ?>
                </div>
                </td>
